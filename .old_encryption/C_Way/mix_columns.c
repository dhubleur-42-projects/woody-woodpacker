...
/*   Updated: 2023/05/16 16:13:33 by jmaia            ###   ###               */
/*                                                                            */
/* ************************************************************************** */
...
static const uint8_t INV_MDS_MATRIX[] = {14, 11, 13, 9, 9, 14, 11, 13, 13, 9, 14, 11, 11, 13, 9, 14};

static const uint8_t MULTIPLY_2[] = {
...
static const uint8_t MULTIPLY_3[] = {
...
static const uint8_t MULTIPLY_9[] = {
...
static const uint8_t MULTIPLY_11[] = {
...
static const uint8_t MULTIPLY_13[] = {
...
static const uint8_t MULTIPLY_14[] = {
...
void	inv_mix_columns(uint8_t *box)
{
	for (int i = 0; i < 4; i++)
	{
		...
		multiply_matrix_4_4_and_vec_4(INV_MDS_MATRIX, box + i * 4, result);
		for (int j = 0; j < 4; j++)
			box[i * 4 + j] = result[j];
	}
}
...
static uint8_t bit_multiply(uint8_t matrix_nbr, uint8_t vec_nbr)
{
	switch (matrix_nbr)
	{
		case 1:
			return vec_nbr;
		case 2:
			return MULTIPLY_2[vec_nbr];
		case 3:
			return MULTIPLY_3[vec_nbr];
		case 9:
			return MULTIPLY_9[vec_nbr];
		case 11:
			return MULTIPLY_11[vec_nbr];
		case 13:
			return MULTIPLY_13[vec_nbr];
		case 14:
			return MULTIPLY_14[vec_nbr];
		default:
			return -42;
	}
}
